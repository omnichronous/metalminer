(function () {
    ...
    lyr.darkLyrics = function (metaInfo, callback) {
        ...
        var uri = settings.corsProxy + 'http://www.darklyrics.com/lyrics/';
    ...
    lyr.metalArchives = function (metaInfo, callback) {
        ...
        var uri = settings.corsProxy + 'http://www.metal-archives.com/search/ajax-advanced/searching/songs/?';
        ...
        request(uri, function (err, res, body) {
            ...
            if (body.aaData.length > 0 && body.aaData[0].length > 4) {
                ...
                var href = settings.corsProxy + 'http://www.metal-archives.com/release/ajax-view-lyrics/id/' + match;
    ...
    lyr.songLyrics = function (metaInfo, callback) {
        ...
        var uri = settings.corsProxy + 'http://www.songlyrics.com/' + metaInfo.artist.toLowerCase().replace(/ /gi, '-') + '/';
