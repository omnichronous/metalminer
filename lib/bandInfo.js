(function () {
    ...
    bi.wikipedia = function (metaInfo, callback) {
        ...
        var uri = settings.corsProxy + 'http://www.google.com/search?q=' + metaInfo.artist.replace(/ /g, '+') + 
    ...
    bi.metalArchives = function (metaInfo, callback) {
        // https://www.metal-archives.com/band/read-more/id/32922
        if (!metaInfo || !callback) {
            return;
        }
        ...
        request.get(uri, function (err, res, body) {
            ...
            if (body.aaData.length > 0 && body.aaData[0].length > 0) {
                ...
                var uri2 = settings.corsProxy + 'http://www.metal-archives.com/band/read-more/id/';
                uri2 += match;
